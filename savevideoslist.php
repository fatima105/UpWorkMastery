...
<body>
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Watch Later</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="javascript:;"><i
                                            class="bx bx-bookmark"></i></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
   ...
   <a href="savevideoslist.php?type=grid" id="btnViewGrid" class="btn btn-white px-1 <?php echo isset($_GET['type']) && $_GET['type'] == "grid" ? "active" : ""; ?>">
  <i id="viewIconGrid" class="fadeIn animated bx bx-grid-small"></i>
</a>
<a href="savevideoslist.php" id="btnViewList" class="btn btn-white px-1 <?php echo !(isset($_GET['type']) && $_GET['type'] == "grid") ? "active" : ""; ?>">
  <i id="viewIconList" class="fadeIn animated bx bx-list-ol"></i>
    ...
    <div id="videoContainer" class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
        ...
        $sql = "SELECT * 
FROM savevideos 
INNER JOIN videos ON savevideos.video_id = videos.id 
WHERE savevideos.user_id = '$userid'";
...
WHERE savevideos.user_id = '$userid'";
    ...
    <div class="d-flex align-items-center">
        ...
        <a href="deletevideofile.php?id=<?php echo $row['id']; ?>" class="widgets-icons  text-danger  mb-4 me-2">
            <i class="bx bxs-trash text-sm"></i>
        </a>
        <a class="widgets-icons mb-4 text-success " href="editvideos.php?id=<?php echo $row['id']; ?>">
